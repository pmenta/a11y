...
export default function Home() {
  return (
    <>
      <Head>
        <title>Desenvolvendo uma web acessível | spicyblog</title>
      </Head>
      <header className={styles.header}>
        ...
        <nav className={styles.nav}>
          <a href="https://github.com/pmenta" target="_blank" rel="noreferrer">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
          ...
          <Dialog.Root>
            ...
            <Dialog.Portal>
              ...
              <Dialog.Content className={styles.modal}>
                ...
                <Dialog.Description>
                  Esta é uma aplicação criada para fins de estudo sobre
                  acessibilidade no React
                </Dialog.Description>
                <Dialog.DialogClose>Fechar</Dialog.DialogClose>
              </Dialog.Content>
            </Dialog.Portal>
          </Dialog.Root>
        </nav>
